...
Bliss-OS (x86) - BlissROM for PCs
-----------------------
Download the Bliss-OS source code, based on [AOSP](https://android.googlesource.com), [phhusson](https://github.com/phhusson/treble_manifest), [skunkworx](https://github.com/skunkworkx/platform_manifest), & [BlissRoms](https://github.com/BlissRoms/platform_manifest)
...
Usage :  
	...
	$ bash build-x86.sh options buildVariants extraOptions
...
After that, you can build your release file :
	...
	$ bash build-x86.sh android_x86_64-userdebug foss (to build the userdebug version for x86_64 CPUs with FDroid & microG included)
